...
// If you already load these fonts globally (e.g. in app/layout.tsx),
// delete this block and swap the className references below for your
// existing font variables instead.
...
export default function FounderGrantSection() {
  return (
